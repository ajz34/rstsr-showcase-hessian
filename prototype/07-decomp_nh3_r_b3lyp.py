"""Reference values for NH3 (restricted) Hessian decomposition with B3LYP (GGA).
...
def main():
    ...
    refs = {
        "de_ref":        (de_ref,         1.4630302131),
        "de_nuc":        (de_nuc,        10.9421515037),
        "de_1":          (de_1,         -17.2303328192),
        "de_J20":        (de_J20,         3.7752826104),
        "de_J11":        (de_J11,         8.9436585553),
        "de_J02":        (de_J02,        -4.4742112613),
        "de_K20":        (de_K20,        -0.8059533447),
        "de_K11":        (de_K11,         9.1320088489),
        "de_K02":        (de_K02,        -4.5652395186),
        "de_xc":         (de_xc,         -0.8985828140),
        "de_cphf":       (de_cphf,        0.7811460368),
        "f1ao_ref":      (f1ao_ref,      -2.7140406820),
        "f1mo_ref":      (f1mo_ref,       4.3516973205),
        "vxc_deriv1":    (vxc_deriv1,    -3.8658927362),
        "vxc_deriv1_mo": (vxc_deriv1_mo,  0.4650346935),
    }
    print(f"=== {XC} (RKS, NH3) ===")
