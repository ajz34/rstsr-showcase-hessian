"""Reference values for NH3 (restricted) Hessian decomposition with TPSS0 (MGGA).
...
def main():
    ...
    refs = {
        "de_ref":        (de_ref,         1.4773310642),
        "de_nuc":        (de_nuc,        10.9421515037),
        "de_1":          (de_1,         -16.9891314350),
        "de_J20":        (de_J20,         3.5401754491),
        "de_J11":        (de_J11,         8.9687229115),
        "de_J02":        (de_J02,        -4.4864764947),
        "de_K20":        (de_K20,        -0.9252902032),
        "de_K11":        (de_K11,         9.1464413342),
        "de_K02":        (de_K02,        -4.5724757250),
        "de_xc":         (de_xc,         -0.8310821568),
        "de_cphf":       (de_cphf,        0.7890557121),
        "f1ao_ref":      (f1ao_ref,      -2.4170164424),
        "f1mo_ref":      (f1mo_ref,       5.7871369056),
        "vxc_deriv1":    (vxc_deriv1,    -3.4184689532),
        "vxc_deriv1_mo": (vxc_deriv1_mo,  0.5250822795),
    }
    print(f"=== {XC} (RKS, NH3) ===")
